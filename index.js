...
async function startRaven() {
  ...
  console.log(
    color(
      figlet.textSync("SOLO LEVELING MD", {
        font: "Standard",
  ...
  const client = ravenConnect({
    ...
    browser: ["SOLO LEVELING MD - AI", "Safari", "5.1.7"],
    auth: state,
...
startRaven()
      ...
      console.log(color("Congrats, SOLO LEVELING MD has successfully connected to this server", "green"));
