...
const botname = process.env.BOTNAME || '𝐒𝐎𝐋𝐎 𝐋𝐄𝐕𝐄𝐋𝐈𝐍𝐆-𝐌𝐃 𝐁𝐎𝐓';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR ||'𝗕𝗢𝗧';
const packname = process.env.STICKER_PACKNAME || '𝐒𝐎𝐋𝐎 𝐋𝐄𝐕𝐄𝐋𝐈𝐍𝐆';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || '94753262213';
const menulink = process.env.MENU_LINK || 'https://files.catbox.moe/qfkj2n.png';
